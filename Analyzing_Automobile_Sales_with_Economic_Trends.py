...
app.layout = html.Div([
    ...
    html.Div([#division for output displays
...
#TASK Creation and displaying of graphs for Recession Report Statistics
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        ...
        R_chart4 = dcc.Graph(figure=px.bar(unemployment_data,
                                        x='Vehicle_Type',
                                        y='unemployment_rate',
                                        title='Unemployment Rate Effect on Vehicle Types Sold during Recession'))
...
# Creation and displaying of graphs for Yearly Report Statistics
